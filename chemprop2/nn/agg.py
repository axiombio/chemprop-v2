...
from chemprop2.utils import ClassRegistry
...
class Aggregation(nn.Module, HasHParams):
    ...
    See also
    --------
    :class:`~chemprop2.v2.models.modules.agg.MeanAggregation`
    :class:`~chemprop2.v2.models.modules.agg.SumAggregation`
    :class:`~chemprop2.v2.models.modules.agg.NormAggregation`
    """
