...
from chemprop2.conf import DEFAULT_HIDDEN_DIM
from chemprop2.nn.ffn import MLP
from chemprop2.nn.hparams import HasHParams
...
from chemprop2.utils import ClassRegistry, Factory
...
class _FFNPredictorBase(Predictor, HyperparametersMixin):
    ...
    _T_default_criterion: chemprop2Metric
    _T_default_metric: chemprop2Metric
    ...
    def __init__(
        ...
        dropout: float = 0.0,
        activation: str = "relu",
        criterion: chemprop2Metric | None = None,
