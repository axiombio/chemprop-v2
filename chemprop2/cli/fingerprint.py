...
from chemprop2.cli.predict import find_models
from chemprop2.cli.utils import Subcommand, build_data_from_files, make_dataset
from chemprop2.models import load_model
...
class FingerprintSubcommand(Subcommand):
    COMMAND = "fingerprint"
    HELP = "Use a pretrained chemprop2 model to calculate learned representations."
