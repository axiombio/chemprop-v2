...
from chemprop2.cli.utils import LookupAction
from chemprop2.cli.utils.args import uppercase
from chemprop2.featurizers import AtomFeatureMode, MoleculeFeaturizerRegistry, RxnMode
...
- ``V1``: Corresponds to the original configuration employed in the chemprop2 V1
- ``V2``: Tailored for a broad range of molecules, this configuration encompasses all elements in the first four rows of the periodic table, along with iodine. It is the default in chemprop2 V2.
