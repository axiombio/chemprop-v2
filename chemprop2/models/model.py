...
from chemprop2.data import BatchMolGraph, MulticomponentTrainingBatch, TrainingBatch
from chemprop2.nn import Aggregation, chemprop2Metric, MessagePassing, Predictor
from chemprop2.nn.transforms import ScaleTransform
from chemprop2.schedulers import build_NoamLike_LRSched
from chemprop2.utils.registry import Factory
...
class MPNN(pl.LightningModule):
    ...
    def __init__(
        ...
        metrics: Iterable[chemprop2Metric] | None = None,
        warmup_epochs: int = 2,
        init_lr: float = 1e-4,
        max_lr: float = 1e-3,
        final_lr: float = 1e-4,
    ...
    @property
    def criterion(self) -> chemprop2Metric:
