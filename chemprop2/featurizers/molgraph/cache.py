...
class MolGraphCache(MolGraphCacheFacade):
    ...
    :class:`~chemprop2.data.molgraph.MolGraph`\s and caches them in memory.
    """
...
class MolGraphCacheOnTheFly(MolGraphCacheFacade):
    ...
    :class:`~chemprop2.data.molgraph.MolGraph`\s as they are requested.
    """
